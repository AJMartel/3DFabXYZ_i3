...
#define STRING_SPLASH_LINE2 "Electron-TEVO i3" // will be shown during bootup in line 2
...
#define MK8_E_STEPS (NEMA17_MOTOR_STEPS / (MK8_GEAR_DIAMETER / M_PI))
...
#define X_MIN_POS -7 //AxMod -17  //Ori 0  //-Left,+Right
#define Y_MIN_POS -4 //AxMod -70  //Ori 0
#define Z_MIN_POS 0
