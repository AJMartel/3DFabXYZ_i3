...
//#define LIN_ADVANCE
   ...
   *
   * Slic3r (including Pru�a Control) produces Gcode compatible with the automatic mode.
...
//#define CUSTOM_USER_MENUS
  ...
  #define USER_DESC_8 "Preheat for NYLON"
