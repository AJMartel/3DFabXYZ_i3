...
#define CONFIGURATION_H_VERSION 010107 //Marlin now checks for a configuration version and won?t compile without this setting. ver 1.1.8
 ...
 * http://www.thingiverse.com/thing:298812  (Calibration Cube)
 */
...
#define STRING_SPLASH_LINE2 "3DFabXYZ i3" // will be shown during bootup in line 2
...
//#define MACHINE_UUID "33f3a111-81c0-4449-9a01-1b2c737aa701"
 ...
 */
//#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 398.269957, 101.640122273 } AXMOD
//#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 398.269957, 94.4962144 } GaryNMcKinney

// A useful trick is to let the compiler do the calculations for you and just supply the raw values.

/*
#define NEMA17_FULL_STEPS 200.0  //1.8 degrees
#define NEMA17_MICROSTEPS 16.0   // 1/16
#define NEMA17_MOTOR_STEPS (NEMA17_FULL_STEPS * NEMA17_MICROSTEPS)
#dPULLEY_PITCH 2.0efine
#define PULLEY_TEETH 20.0
#define Z_ROD_PITCH 2.0    // T8
#define Z_ROD_STARTS 4.0   // T8
#define XY_STEPS (NEMA17_MOTOR_STEPS / (PULLEY_PITCH * PULLEY_TEETH))
#define Z_STEPS (NEMA17_MOTOR_STEPS / (Z_ROD_PITCH * Z_ROD_STARTS))
#define MK8_GEAR_DIAMETER 10.68
#define MK8_E_STEPS 94.4962144  //(NEMA17_MOTOR_STEPS / (MK8_GEAR_DIAMETER / M_PI))

\\(DesiredMovement/ActualMovement)*CurrentValue  Do for each axix X, Y, Z.

#define DEFAULT_AXIS_STEPS_PER_UNIT   { XY_STEPS, XY_STEPS, Z_STEPS, MK8_E_STEPS }
//                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
*/

//#define DEFAULT_AXIS_STEPS_PER_UNIT   { 79.3650221, 79.5665514, 397.1898355 , 99.4696994 }
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 79.8762300, 79.6302556, 403.7302658 , 99.4696994 }
...
#define Z_BED_SIZE 185

#define XTRA_BED_LEFT 7     // Distance nozzle can move towards the left past X = 0
#define XTRA_BED_RIGHT 0  // Distance nozzle can move towards the right past X = 200
#define XTRA_BED_FRONT 4    // Distance bed can move towards the front past Y = 200 (Y=280 for large bed)
#define XTRA_BED_BACK 0     // Distance bed can move towards the back past Y = 0

// Travel limits (mm) after homing, corresponding to endstop positions.
#define X_MIN_POS (0 - XTRA_BED_LEFT)   //AxMod -17  //Ori 0  //-Left,+Right
#define Y_MIN_POS (0 - XTRA_BED_BACK)   //AxMod -70  //Ori 0
#define Z_MIN_POS 0
...
#define MANUAL_X_HOME_POS 0 // -119
#define MANUAL_Y_HOME_POS 0 // -146
...
// Preheat Constants
#define PREHEAT_1_TEMP_HOTEND 205  //PLA
